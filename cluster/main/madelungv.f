...
c         cperpc - perp. position of the plane of the external capacitor
...
c  This part should be revised before use 12/02/2021 Laszloffy
c
c       vmad(ip)=vmad(ip)+2.0d0*fac*qc*
c    >  (dmin1(clay(nshift+ip,3),cperpc)-clay(nshift+iq,3))
c
        if(itest.ge.2)
