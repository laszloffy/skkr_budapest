...
c
      ...
      include '../param.h'                 
c
      dimension bspr(nrad),bopr(nrad,2)
      dimension ba11(nrad),ba12(nrad),ba22(nrad)
      dimension bb11(nrad),bb22(nrad),br(nrad,2)
c
      dimension u1(50),ind1(50)
      dimension u2(50),ind2(50)
      common/cgc/u1,u2,ind1,ind2
c
      call rzero(ba11,nrad)
      call rzero(ba12,nrad)
      call rzero(ba22,nrad)
      call rzero(bb11,nrad)
      call rzero(bb22,nrad)
c
      do i=1,n
        br(i,1)=-bspr(i)
        br(i,2)=bspr(i)
