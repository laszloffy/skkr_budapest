c     Name of Copyright owners: Gabor Csire, Andras Laszloffy, Bendeguz Nyari, Laszlo Szunyogh, and Balazs Ujfalussy
      subroutine matrot2(r0,r1,lmax,dmat,dmatp,dz,tvec,phi,
...
c
      ...
      complex*16 d(kmaxp+1,kmaxp+1),dz(3)
c
      common/test/itest
c
      pi=4.d0*datan(1.d0)
...
c
     ...
     >           ddth,ddthp,d2dth,d2dthp,d2dthph,d2dthphp,d)
c
c Set up matrix of rotation for spherical harmonics with l=1 and m=0
c
c      call rotmat2(d,trd,ddphi,d2dphi,3,tlm,1)
