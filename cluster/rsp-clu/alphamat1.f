c     Name of Copyright owners: Gabor Csire, Andras Laszloffy, Bendeguz Nyari, Laszlo Szunyogh, and Balazs Ujfalussy
      subroutine alphamat1(ce,vscreen,lmax,nintfc)
c=========================
c
...
c
      include '../param.h'
c
      complex*16 alphaintkkr
      complex*16 ce,cs,ck,csk,tand,react,sqrm1
...
c
      ...
      common/scrpar/alphaintkkr(0:lmaxp,mintfc)
      common/test/itest
c
...
c     do n=1,ninprcl
c        write(6,'(''smtl(n):  n='',i2,4x,f14.12)') n,smtl(n)
c        write(6,'(10f12.8)') (alphalkkr(l,n),l=0,lmax)
c     enddo
c     do n=1,ninprcr
c        write(6,'(''smtr(n):  n='',i2,4x,f14.12)') n,smtr(n)
c        write(6,'(10f12.8)') (alpharkkr(l,n),l=0,lmax)
c     enddo
      do n=1,nintfc
