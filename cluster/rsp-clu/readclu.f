...
c -------------------------------------------------
c
c read orientation of the frame for the derivatives
      read(5,*) theta0,phi0
      theta0 = theta0*pi/180.d0
      phi0 = phi0*pi/180.d0
c read parameters to control write out tau matrix, and the wavefunctions
c  iwtau = 0,1
c  nwtau = n  number of the atom the tau matrix is written for
      read(5,*) iwtau, nwtau
c
      close(5)
c DEBUG BEGINN
