...
c
      ...
      dimension th0a(mintfc),th1a(mintfc),th2a(mintfc)
      dimension ph0a(mintfc),ph1a(mintfc),ph2a(mintfc)
      dimension spinmomb(mintfc),orbmomb(mintfc)
      dimension th0b(mintfc),th1b(mintfc),th2b(mintfc)
      dimension ph0b(mintfc),ph1b(mintfc),ph2b(mintfc) 
c
      dimension xbr(mbrdir),fbr(mbrdir)
      dimension dfbr(mbrdir),pfbr(mbrdir),pxbr(mbrdir),denbr(mbrdir),
     >          defbr(mbrdir)
c
...
c     ----------------------------------------------------------------
     ...
     >           dmix,wbrdir,31,32,33,'ftn31','ftn32','ftn33')
c     ----------------------------------------------------------------
