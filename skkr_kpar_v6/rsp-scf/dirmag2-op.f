...
c
      ...
      complex*16 g,gp,f
c
      dimension vr(nrad),bspr(nrad),bopr(nrad,2)
      dimension ba11(nrad),ba12(nrad),ba22(nrad),bb11(nrad),bb22(nrad)
      dimension p1(nrad),p2(nrad),q1(nrad),q2(nrad)
      dimension pp1(nrad),pp2(nrad),qp1(nrad),qp2(nrad)
      dimension fk1(2),fk2(2),gk1(2),gk2(2)
      dimension g(2,2,nrad),gp(2,2),f(2,2,nrad)
...
c
      dimension vr(nrad),bspr(nrad),bopr(nrad,2)
      dimension xlag(nrad),vrlag(nrad),bsprlag(nrad),boprlag(nrad,2)
      dimension ba11(nrad),ba12(nrad),ba22(nrad),bb11(nrad),bb22(nrad)
      dimension p1(nrad),p2(nrad),q1(nrad),q2(nrad)
      dimension pp1(nrad),pp2(nrad),qp1(nrad),qp2(nrad)
      dimension fk1(2),fk2(2),gk1(2),gk2(2)
...
c
      x=xs+nout*dx
      r=dexp(x)
      call csbf(l+1,l1maxp,pe,r,fb,fn,fh)
      n=ns+nout
c
      if(ii.eq.2) go to 40
      p1(n) = r*fb(l)
