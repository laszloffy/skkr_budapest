c     Name of Copyright owners: Gabor Csire, Andras Laszloffy, Bendeguz Nyari, Laszlo Szunyogh, and Balazs Ujfalussy
     ...
     >                 ddth,ddth1,d2dth,d2dth1,d2dthph,d2dthph1)
c ===================
c
c R=(tvec,Phi)
...
c
      complex*16 d(jdim,jdim),ddthe(jdim,jdim),d2dthe(jdim,jdim)
...
c
      ...
      call czero(ddph,kmymaxp*kmymaxp)
      call czero(ddph1,kmymaxp*kmymaxp)
      call czero(d2dph,kmymaxp*kmymaxp)
      call czero(d2dph1,kmymaxp*kmymaxp)
      call czero(ddth,kmymaxp*kmymaxp)
      call czero(ddth1,kmymaxp*kmymaxp)
      call czero(d2dth,kmymaxp*kmymaxp)
      call czero(d2dth1,kmymaxp*kmymaxp)
      call czero(d2dthph,kmymaxp*kmymaxp)
      call czero(d2dthph1,kmymaxp*kmymaxp)
c
