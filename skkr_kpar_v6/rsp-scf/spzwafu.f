...
c
      ...
      complex*16 fz(nrad,2,2),gz(nrad,2,2)
      complex*16 fj(nrad,2,2),gj(nrad,2,2)
      complex*16 f1(2,2,nrad),g1(2,2,nrad),gp1(2,2)
      complex*16 f2(2,2,nrad),g2(2,2,nrad),gp2(2,2)
      complex*16 f11(nrad),g11(nrad),f12(nrad),g12(nrad)
...
c
      call czero(gz,4*nrad)
      call czero(fz,4*nrad)
      call czero(gj,4*nrad)
      call czero(fj,4*nrad)
      call czero(tminv,4)
      call czero(jmat,4)
      call czero(jbmat,4)
      call czero(nmat,4)
...
c
      ...
      smlm1=smlm1*ce/psq
c
      call csbf(l+1,l1maxp,p,rs,fb,fn,fh)
c
...
c       write(6,'('' gpmt irr  '',2d15.8)') ff2*rs
        ...
        ff2=f12(ns)/rs
c       write(6,'('' gmt irr  '',2d15.8)') gg2*rs
c       write(6,'('' fmt irr  '',2d15.8)') ff2*rs*c
        ggam2=ff2/gg2 
...
c
      return 
c
    1 call dirmago2op(socsc,ce,l,my,vr,br,bopr,dx,xnot,rs,ns,
     >                g1,f1,gp1)
