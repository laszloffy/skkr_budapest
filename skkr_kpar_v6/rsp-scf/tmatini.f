...
c        --------------------------------------------------------------
         call alphamat(psq,iscreen,vscreen,lmax,nintfc,ninprcl,ninprcr)
c        --------------------------------------------------------------
      end if
c
c **********************************************************
...
c       call outmat1(tminva(1,1,li),kmymax,kmymax,kmymaxp,tol,6)
        call tripmt(dmata(1,1,li),tminva(1,1,li),dmatpa(1,1,li),
     >              kmymax,kmymax,kmymaxp)
c       write(6,*) '  screened tm1 matrix rotated'
c       call outmat1(tminva(1,1,li),kmymax,kmymax,kmymaxp,tol,6)
c       ---------------------------------------------------------------
