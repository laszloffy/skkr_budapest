...
c       write(6,'(2f20.10)')  qbulkl(ibulk),dbulkl(ibulk) 
      end do
c     write(6,*)
      do ibulk=1,nbulkr
        qbulkr(ibulk)=0.d0
...
c       write(6,'(2f20.10)')  qbulkr(ibulk),dbulkr(ibulk) 
      end do
c     write(6,*)
c
...
c       qlay(li)=qbulkl(1)
c       dlay(li)=dbulkl(1)
c       write(6,'(2f20.10)') qlay(li),dlay(li)
      end do
c     write(6,*)
c
c --------------------------------------------------------
...
c
c     write(6,'('' vl='',f20.10)') vleft
c     write(6,'('' vr='',f20.10)') vright
c     write(6,'('' v0='',f20.10)') v0
c     write(6,'('' v1='',f20.10)') vnp1
c
      bcoeff=vleft-v0
      do iq=1,nintfc
        bcoeff=bcoeff+
...
c
c     write(6,'('' acoeff='',f20.10)') acoeff
c     write(6,'('' bcoeff='',f20.10)') bcoeff
c
c -------------------------------------------------------
c
...
c       write(6,'('' MAD 0='',f20.10)') vmad(ip)
c
c
c 1. G.ne.0 terms
c
...
c       write(6,'('' MAD L='',f20.10)') vmad(ip)
c
        do jbulk=1,nbulkr
c         write(6,'(/'' jbulk='',i3)') jbulk
c Loop over inequivalent sublattices in the bulk to the right
...
c       write(6,'('' MAD R='',f20.10)') vmad(ip)
c
        do iq=1,nintfc
c Loop over interfacial layers
c
...
c       write(6,'('' MAD I='',f20.10)') vmad(ip)
c
c 2. G=0 terms
c
        do iq=1,nintfc
