...
c***********************************************************************
      subroutine gstore(park,ce,factor,bulkgeo,side,
     >                  lmax,nintfc_true,g2d)
c
...
c
      complex*16 ce,g2d(lmmaxp,lmmaxp,-minprc:minprc,minprc,0:mprc1+1)
...
c                   write(6,*) ' Direct method'
              if (j.gt.i) then
c               -------------------------------------------------
                call directg(park,sep(1),ce,lmax,
...
c
c             --------------------------------------------------
              call kamstr(gtotal(1,1,j,i),ce,park(1),park(2),
...
c     end do
c
c - do the screening transformation
c
c     ------------------------------------------------------------------
      call scrstr(gtotal,nl2,ntotal,nextra,ninprcl,ninprcr,bulkgeo,side)
c     -----------------------------------------------------------------
c
