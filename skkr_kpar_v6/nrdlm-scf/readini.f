c     Name of Copyright owners: Gabor Csire, Andras Laszloffy, Bendeguz Nyari, Laszlo Szunyogh, and Balazs Ujfalussy
     ...
     >eta,sigma,park,kset,itcpam,cpatol,cpatest,cpain,
...
c      
      logical rel,bulk,dos,nspheres,cpatest,dlm,cpain
      character*25 job
...
c
      write(6,'(/'' Disordered Local Moment calculation'')')
      write(6,*)
...
c
c - option for DLM (in this code obsolete)
c
      read(5,*) dlm
c
