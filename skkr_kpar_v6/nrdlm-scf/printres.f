c     Name of Copyright owners: Gabor Csire, Andras Laszloffy, Bendeguz Nyari, Laszlo Szunyogh, and Balazs Ujfalussy
     ...
     >it,lmax,nintfc,ne,cear,efermi,conc,bulk,
...
c
      ...
      do li=1,nintfc
        ...
        do ie=1,ne
          ...
          sum=0.d0
          do l=0,lmax
            sum=sum+dosa(l,li,1,ie)
          end do
          write(8,'(f10.6,5f10.4)') er,(dosa(l,li,1,ie),
     >                                 l=0,lmax),sum
        end do
        do ie=1,ne
          er=dreal(cear(ie))
          sum=0.d0
          do i=1,lmmax
            sum=sum+doslma(i,li,1,ie)
          end do
          write(9,'(f10.6,10f10.4)') er,(doslma(i,li,1,ie),
     >                                 i=1,lmmax),sum
        end do
        if(cpalay) then
        write(8,'(''##'',t10,''B'')')
        ...
        do ie=1,ne
          ...
          sum=0.d0
          do l=0,lmax
            sum=sum+dosb(l,li,1,ie)
          end do
          write(8,'(f10.6,5f10.4)') er,(dosb(l,li,1,ie),
     >                                 l=0,lmax),sum
        end do
        do ie=1,ne
          er=dreal(cear(ie))
          sum=0.d0
          do i=1,lmmax
            sum=sum+doslmb(i,li,1,ie)
          end do
          write(9,'(f10.6,10f10.4)') er,(doslmb(i,li,1,ie),
     >                                 i=1,lmmax),sum
        end do
        end if
      end do
      ...
      do li=1,nintfc
        ...
        do ie=1,ne
          ...
          sum=0.d0
          do l=0,lmax
            sum=sum+dosa(l,li,2,ie)
          end do
          write(8,'(f10.6,5f10.4)') er,(dosa(l,li,2,ie),
     >                                 l=0,lmax),sum
        end do
        do ie=1,ne
          er=dreal(cear(ie))
          sum=0.d0
          do i=1,lmmax
            sum=sum+doslma(i,li,2,ie)
          end do
          write(9,'(f10.6,10f10.4)') er,(doslma(i,li,2,ie),
     >                                 i=1,lmmax),sum
        end do
        if(cpalay) then
        write(8,'(''##'',t10,''B'')')
        ...
        do ie=1,ne
          ...
          sum=0.d0
          do l=0,lmax
            sum=sum+dosb(l,li,2,ie)
          end do
          write(8,'(f10.6,5f10.4)') er,(dosb(l,li,2,ie),
     >                                 l=0,lmax),sum
        end do
        do ie=1,ne
          er=dreal(cear(ie))
          sum=0.d0
          do i=1,lmmax
            sum=sum+doslmb(i,li,2,ie)
          end do
          write(9,'(f10.6,10f10.4)') er,(doslmb(i,li,2,ie),
     >                                 i=1,lmmax),sum
        end do
        end if
      end do
