...
c     (bogo rel):mdimp=mdimdbogo, lkmax=2*kmymax
c-------------------------------------------------    
c
      implicit none
...
c --------------- end of original version ----------------------
        ...
        do ilay = 1,nlay
         ...
         do jlay = 1,nlay
          ...
          do il = 1,lkmax
           do jl = 1,lkmax
            tau(il,jl,ilay+ii0,jlay+ii0) = wgeff*
     >                 tau00(il+il0,jl+jl0,iiprc)
           end do 
          end do 
         end do 
c
          ...
          if(itest.gt.2.or.tautest) then
           ...
           call outmat1(tau(1,1,ilay,ilay),lkmax,lkmax,lkmax,tol,6)
          endif 
c
         end do 
c
         ...
         do llay = 1,ninprc(iiprc)
          ...
          do jlay = 1,ninprc(jjprc)
           ...
           do l = 1,lkmax
            ...
            do lp = 1,lkmax
             jl = jl0 + lp
             tau(lp,l,jlay+jj0,llay+ii0) = wgeff*help(jl,il)
            end do 
           end do 
          end do 
         end do 
