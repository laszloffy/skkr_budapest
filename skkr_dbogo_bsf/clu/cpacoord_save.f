...
c
      ...
      complex*16 tau_ijsum(kmymaxp,kmymaxp,mpair)
...
c
        ...
        if(iek.eq.mek+1) 
     >  write(6,'(/''WARNING: iek='',i8,'' greater than mek='',i8/
...
c
      tau_ijsum = (0.d0,0.d0)
      call mpi_reduce(tau_ij,tau_ijsum,kmymaxp*kmymaxp*mpair,
     >     mpi_double_complex,mpi_sum,root,mpi_comm_world,ierr)
      tau_ij = tau_ijsum
c
      tau_ijsum = (0.d0,0.d0)
      call mpi_reduce(tau_ji,tau_ijsum,kmymaxp*kmymaxp*mpair,
     >     mpi_double_complex,mpi_sum,root,mpi_comm_world,ierr)
      tau_ji = tau_ijsum
c
c **********
