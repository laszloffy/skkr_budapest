...
c
      complex*16 deltal(nrad,minprc),deltar(nrad,minprc)
      complex*16 delta(nrad,mintfc)
      complex*16 delta0(nrad,mintfc)
      dimension redelta(nrad,mintfc)
      dimension imdelta(nrad,mintfc)
...
c
      dimension rlambdal(minprc),rlambdar(minprc)
...
c     ------------------------------------------------------------------
     ...
     > leftdelta,rightdelta,laydelta,deltal,deltar,delta,
     > rlambdal,rlambdar,rlambda)
c     ------------------------------------------------------------------
c
...
c     ------------------------------------------------------------------
      ...
      call sublattpot(nintfc,ns,delta,iesublatt)
c     ------------------------------------------------------------------
      if(bulk) then
c     ------------------------------------------------------------------
...
c     ------------------------------------------------------------------
      call initzero(qvpa,qvpb,qva,qvha,qveha,qvhea,qvteha,qvthea,qvb,
...
c     ------------------------------------------------------------------ 
     ...
     > rbl,rbr,rba,rbb,deltal,deltar,delta,c_light)
c     ------------------------------------------------------------------ 
...
c     ------------------------------------------------------------------
     ...
     > qca,za,qvb,qcb,zb,enba,enbb,efermi,
     > ddphenba,ddthenba,d2dphenba,d2dthenba,d2dthphenba,
     > ddphenbb,ddthenbb,d2dphenbb,d2dthenbb,d2dthphenbb,
...
c
      ...
      call deltamix(itscf,itscfcont,nintfc,lmax,iesublatt,
...
c     ------------------------------------------------------------------
      ...
      call delta_bcast(ferr1,rlambda,delta,qveha,qvhea,entotifc)
c
      if(itscf.eq.1) then
...
c     ------------------------------------------------------------------
     ...
     >     conc,dosa,dosb,dosha,doseha,doshea,dosteha,dosthea,
