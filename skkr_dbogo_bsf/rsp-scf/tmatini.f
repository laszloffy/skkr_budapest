...
c
      tautest=.false.
      if(tautest) then
       write(6,*) ' <tmatini> : tautest, after tmat for a component'
       write(6,*) "ce=",ce
       write(6,*) "c=",c
       write(6,*) "sxcl=",sxa(li)
       write(6,*) "idpota(a)=",idpota(li)
       write(6,*) "v0=",v0
       write(6,*) "E_Fermi=",E_Fermi
       write(6,*) "deltaa(1,li)=",deltaa(1:nrad,li)
       write(6,*) "vra(1,li)=",vra(1:nrad,li)
       write(6,*) "bra(1,li)=",bra(1:nrad,li)
       write(6,*) "dx(li)=",dx(li)
       write(6,*) "rs(li)=",rs(li)
       write(6,*) "ns(li)=",ns(li)
       write(6,*) ' <tmatini> : tautest, tminva imp=',li
       call outmat1(tminva(1,1,li),2*kmymax,2*kmymax,dbogomaxp,
     >              tol,6)
       write(6,*) ' <tmatini> : tautest, ptminva imp=',li
       call outmat1(ptminva(1,1,li),2*kmymax,2*kmymax,dbogomaxp,
     >              tol,6)
