c     Name of Copyright owners: Gabor Csire, Andras Laszloffy, Bendeguz Nyari, Laszlo Szunyogh, and Balazs Ujfalussy
      subroutine sphbas(dg,dg1,ng,invg,kmymax)
c======================
c
...
c
        ...
        do j=1,kmymax
          dg(i,j,ig)=d(i,j)
          dg(i+kmymax,j+kmymax,ig)=d(i,j)
          dg1(i,j,ig)=dconjg(d(j,i))
          dg1(i+kmymax,j+kmymax,ig)=dconjg(d(j,i))
        end do 
        end do 
c
      end do
c
      ...
      do ig=1,ng 
      dg(:,:,ig)=matmul(ctrafo,dg(:,:,ig))
      dg1(:,:,ig)=matmul(ctrafo,dg1(:,:,ig))
      call gjinv(ctrafo,dbogomaxp,dbogomaxp,detl)
      dg(:,:,ig)=matmul(dg(:,:,ig),ctrafo)
      dg1(:,:,ig)=matmul(dg1(:,:,ig),ctrafo)
      end do
c      dg((kmymax+1):2*kmymax,(kmymax+1):2*kmymax,ig)=
c     >   matmul(conjkmy,dg((kmymax+1):2*kmymax,(kmymax+1):2*kmymax,ig))
c      dg1((kmymax+1):2*kmymax,(kmymax+1):2*kmymax,ig)=
c     >   matmul(conjkmy,dg1((kmymax+1):2*kmymax,(kmymax+1):2*kmymax,ig))
c      call gjinv(conjkmy,kmymaxp,kmymaxp,detl)
c      dg((kmymax+1):2*kmymax,(kmymax+1):2*kmymax,ig)=
c     >  matmul(dg((kmymax+1):2*kmymax,(kmymax+1):2*kmymax,ig),conjkmy)
c      dg1((kmymax+1):2*kmymax,(kmymax+1):2*kmymax,ig)=
c     >  matmul(dg1((kmymax+1):2*kmymax,(kmymax+1):2*kmymax,ig),conjkmy)
c      end do
c
      return
      end
