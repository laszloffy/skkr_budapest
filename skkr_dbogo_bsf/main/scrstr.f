...
c--write gtotal(l,lp,i,j) to matrix form---
      ...
      if(tautest) then
        tol=1e-10
        write(6,*) '<scrstr> : tautest, unscreened g0 8 8 block:'
        call outmat1(gtotal(1,1,8,8),nl2,nl2,lmmaxp,tol,6)
        write(6,*) '<scrstr> : tautest, unscreened g0 8 12 block:'
        call outmat1(gtotal(1,1,8,12),nl2,nl2,lmmaxp,tol,6)
      end if
c ----------holes----------
      if(ihole) then
        do i=1,nl2*nlayer
